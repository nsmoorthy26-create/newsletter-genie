...
> = {
  midnight: {
    ...
    accent: "#7c9cff",
    accentSoft: "rgba(124,156,255,0.15)",
    ring: "ring-[#7c9cff]/30",
    pattern:
      "radial-gradient(circle at 20% 0%, rgba(124,156,255,0.18), transparent 50%), radial-gradient(circle at 80% 100%, rgba(236,72,153,0.12), transparent 50%)",
  },
  sunrise: {
    name: "Sunrise Press",
    bg: "bg-[#fff7ed]",
    ...
    pattern:
      "radial-gradient(circle at 0% 0%, rgba(234,88,12,0.15), transparent 45%), radial-gradient(circle at 100% 100%, rgba(217,119,6,0.12), transparent 45%)",
  },
  forest: {
    ...
    pattern:
      "radial-gradient(circle at 100% 0%, rgba(4,120,87,0.18), transparent 50%), radial-gradient(circle at 0% 100%, rgba(16,185,129,0.12), transparent 50%)",
  },
  mono: {
    name: "Mono Brutalist",
    bg: "bg-stone-100",
